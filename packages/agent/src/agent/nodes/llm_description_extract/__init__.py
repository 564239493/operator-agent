...
Flow:
    START -> fetch_sections -> [extract_ws || extract_exe] -> validate_results -> save_descriptions -> END
"""
...
def create_description_extract_subgraph() -> CompiledStateGraph:
    ...
    Flow:
        fetch_sections -> [extract_ws || extract_exe] -> validate_results -> save_descriptions
    """
    ...
    graph.add_edge("validate_results", "save_descriptions")
